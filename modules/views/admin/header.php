...
<head>
    ...
    <link rel="stylesheet" href="<?php echo Backstage::gi()->TEMPLATE_URL; ?>css/admin.css">
    ...
    <script type="text/javascript" charset="utf-8" src="<?php echo Backstage::gi()->TEMPLATE_URL; ?>js/easyLQ.js"></script>
